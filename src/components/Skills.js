...
function SkillCard({ icon, name }) {
  return (
    <div className="w-full max-w-[200px] rounded-xl border border-[#333] bg-[#111] px-4 py-6 text-center transition duration-300 hover:-translate-y-1 hover:border-[#b9b9ff]">

      {icon && (
        <i
          className={`${icon} mb-2 block text-3xl text-[#b9b9ff] transition duration-500 hover:rotate-[360deg]`}
        ></i>
      )}
